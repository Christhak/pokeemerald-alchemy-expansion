...
static const struct LevelUpMove sVictiniLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(88, MOVE_FLAME_CHARGE),
    LEVEL_UP_MOVE(89, MOVE_REVERSAL),
    LEVEL_UP_MOVE(90, MOVE_FLAME_BURST),
    LEVEL_UP_MOVE(91, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(92, MOVE_INFERNO),
    LEVEL_UP_MOVE(93, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(94, MOVE_FLARE_BLITZ),
    LEVEL_UP_MOVE(95, MOVE_FINAL_GAMBIT),
    LEVEL_UP_MOVE(96, MOVE_STORED_POWER),
