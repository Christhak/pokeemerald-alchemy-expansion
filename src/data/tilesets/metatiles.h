...
const u16 gMetatiles_EnchantedForest[] = INCBIN_U16("data/tilesets/secondary/enchanted_forest/metatiles.bin");
const u16 gMetatileAttributes_EnchantedForest[] = INCBIN_U16("data/tilesets/secondary/enchanted_forest/metatile_attributes.bin");