...
const u8 gText_ThisIsAPokemon[] = _("{PAUSE 96}");
...
const u8 gText_BirchInTrouble[] = _("Someone has left their bag in here!\nTake one, we've got conscience!");
const u8 gText_ConfirmStarterChoice[] = _("Do you want to nab this one?");
